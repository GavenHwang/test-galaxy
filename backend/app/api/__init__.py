...
from .ui_product_role import router as ui_product_role_router
...
api_router.include_router(ui_product_role_router, prefix="/ui-test/product-roles", tags=["UI测试-产品角色"])
